...
columns_to_extract = ["Area", "Item", "Element", "Unit", "Source"]
...
filtered_data = selected_columns[
    (selected_columns["Element"] == "Direct emissions (N2O)") &
    (selected_columns["Item"] == "Synthetic Fertilizers") &
...
output_file_path = "C:/Users/mgaya/OneDrive/Documents/Nanofertech/Webpage/Dataset/Synthetic Fertilizer_Emissions_N2O.csv"
