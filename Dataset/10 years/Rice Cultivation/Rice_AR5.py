...
filtered_data = selected_columns[
    ...
    (selected_columns["Element"].isin(["Emissions (CO2eq) (AR5)"])) & 
...
output_file_path = "C:/Users/mgaya/OneDrive/Documents/Nanofertech/Webpage/Dataset/10 years/RiceCultivation_AR5_data.csv"
