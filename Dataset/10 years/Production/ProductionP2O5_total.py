...
filtered_data = selected_columns[selected_columns["Element"].isin(["Production", "Import Quantity", "Export Quantity"])& 
         (selected_columns["Item"].isin(["Nutrient phosphate P2O5 (total)"]))
         ]
...
output_file_path = "C:/Users/mgaya/OneDrive/Documents/Nanofertech/Webpage/Dataset/10 years/Production/ProductionP2O5_total.csv"
