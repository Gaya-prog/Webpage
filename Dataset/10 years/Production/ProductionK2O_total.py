...
filtered_data = selected_columns[selected_columns["Element"].isin(["Production", "Import Quantity", "Export Quantity"])& 
         (selected_columns["Item"].isin(["Nutrient potash K2O (total)"]))
         ]
...
output_file_path = "C:/Users/mgaya/OneDrive/Documents/Nanofertech/Webpage/Dataset/10 years/Production/ProductionK20_total.csv"
