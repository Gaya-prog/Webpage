...
generate_violin_plots <- function(file_path, output_file_name) {
  ...
  ggsave(output_file_name, violin_plot, width = 12, height = 8)
  
  cat("Violin plot saved to:", output_file_name, "\n")
}

# File path for the first file
file_path <- "C:/Users/mgaya/OneDrive/Documents/Nanofertech/Webpage/Dataset/10 years/Total Input Nutrient/P2O5/LAST 50.csv"
